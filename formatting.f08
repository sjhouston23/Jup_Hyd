...
H01="(' Charge state equilibrium fractions.',/,' Energy [keV/u]',7x,'H-',9x,&
  'H',8x,'H+')",&
H02="(' H^+ production rate [cm^-3 s^-1] from hydrogen ion precipitation.',/,&
  ' Input of 1 ion/cm^2/s.',/,&
  ' Alt [km] Production Rate')",&
H03="(' H_2^+ production rate [cm^-3 s^-1] from hydrogen ion precipitation.',/,&
  ' Input of 1 ion/cm^2/s.',/,&
  ' Alt [km] Production Rate')",&
H04="(' H_2 excitation rate [cm^-3 s^-1] from hydrogen ion precipitation.',/,&
  ' Input of 1 ion/cm^2/s.',/,&
